...
# Load data from Google Sheets (downloaded as CSV for the app)
@st.cache_data
def load_data():
    url = "https://docs.google.com/spreadsheets/d/19nCJDpcgsz2PPrxGnBBkTp5zCTDpbRlgGhad3cWg6BE/export?format=csv&id=19nCJDpcgsz2PPrxGnBBkTp5zCTDpbRlgGhad3cWg6BE&gid=1047819931"
